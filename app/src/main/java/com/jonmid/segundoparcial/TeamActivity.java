...
import com.jonmid.segundoparcial.Adapter.TeamAdapterSalasAlejandra;
import com.jonmid.segundoparcial.Connection.Connection;
import com.jonmid.segundoparcial.Model.TeamModelSalasAlejandra;
import com.jonmid.segundoparcial.Parser.TeamJsonSalasAlejandra;
...
public class TeamActivity extends AppCompatActivity {
    ...
    List<TeamModelSalasAlejandra> teamModelSalasAlejandraList;
    TeamAdapterSalasAlejandra teamAdapterSalasAlejandra;
    ...
    public void processData(){
        teamAdapterSalasAlejandra = new TeamAdapterSalasAlejandra(teamModelSalasAlejandraList, getApplicationContext());
        recyclerViewAlbum.setAdapter(teamAdapterSalasAlejandra);
    }
    ...
    public class TaskAlbum extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                teamModelSalasAlejandraList = TeamJsonSalasAlejandra.getData(s);
